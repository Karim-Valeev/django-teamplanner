...
class AsyncToSync:
    ...
    def __call__(self, *args, **kwargs):
        ...
        # account_pages event loop's thread if it's there, otherwise make a new loop
        # in this thread.
        try:
...
class SyncToAsync:
    ...
    outermost), this will just be the account_pages thread. This is achieved by idling
    ...
    # Storage for account_pages event loop references
